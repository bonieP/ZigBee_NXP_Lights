...
/* NPDU Pool */
PRIVATE pdum_tsNPdu s_asNPduPool[21];
...
PRIVATE uint8 s_au8apduZCLInstance0Storage[80];
PRIVATE uint8 s_au8apduZCLInstance1Storage[80];
PRIVATE uint8 s_au8apduZCLInstance2Storage[80];
PRIVATE uint8 s_au8apduZCLInstance3Storage[80];
PRIVATE uint8 s_au8apduZCLInstance4Storage[80];
PRIVATE uint8 s_au8apduZCLInstance5Storage[80];
PRIVATE uint8 s_au8apduZCLInstance6Storage[80];
PRIVATE uint8 s_au8apduZCLInstance7Storage[80];
PRIVATE uint8 s_au8apduZCLInstance8Storage[80];
PRIVATE uint8 s_au8apduZCLInstance9Storage[80];
...
#endif
    pdum_vNPduInit(s_asNPduPool, 21, mutexMAC);
